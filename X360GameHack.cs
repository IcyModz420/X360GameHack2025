...
namespace X360GameHack
{
    public partial class X360GameHack : MetroForm
    {
            ...
            using (OpenFileDialog openFileDialog = new OpenFileDialog())
            {
                ...
                if (openFileDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    if (filePath.Contains(".xex"))
                    {
                       ...
                       // MessageBox.Show(invoker.XexFilePath);
                        textBox1.Text = filePath; //show path
                       // MessageBox.Show("invoker =" + invoker.XexFilePath + "but textbox =" + textBox1.Text);
                        groupBox4.Show();
                    }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            if (Pastebin.IsLatestVersion() == true)
            {
                Text = Text + " " + Pastebin.CurrentVersion + " Latest Version";
            }
            else
            {
                Text = Text + " Your Using An Outdated Version!" + " Latest Version is " + Pastebin.GetLatestVersion() + "!";
            }
        ...
        private void button10_Click_2(object sender, EventArgs e)
        {
            if (checkBox28.Checked)
            {
                ...
                this.Text = "X360GameHack 2025 " + Pastebin.CurrentVersion + " (Waiting on XISO...)";
                Thread.Sleep(10000);
        ...
        private void button17_Click(object sender, EventArgs e)
        {
            ...
            {
                this.Text = "X360GameHack 2025 " + Pastebin.CurrentVersion + " (Uploading Game...)";
       ...
       //   
        ...
        {
            MessageBox.Show("Video to be added!", "X360GameHack Info!");
        }
        ...
        {
            MessageBox.Show("If you have an RGH hacked system then no you do not need the system update files and it saves space on the console by deleing it.");
        }

        private void button33_Click(object sender, EventArgs e)
        {
            MessageBox.Show("MSCOMCTL.OCX is a dependency of xbox image tool and xbox backup creator you must register it with regsvr during first time use to use either of these programs.");
        }
        ...
        {
            MessageBox.Show("Enjoying X360GameHack? Consider buying me a monster energy drink with cashapp $Collin3400 your donations are apprecieated and contribute to the further development of this tool.");
        }
        ...
        {
            MessageBox.Show("You will need an FTP server running to connect. \n To do this just open FSD, Xexmenu, Aroura, etc to start the server. \n\n Then use the IP to connect with other settings left default.");
        }
        ...
        {
            MessageBox.Show("Install and Open abgx360 and select all regions when pathing the ISO.", "X360GameHack Info!");
        }

        private void button66_Click(object sender, EventArgs e)
        {
            ExtractSeveralGames esg = new ExtractSeveralGames();
            esg.Show();
        }
