...
namespace X360GameHack
{
    public partial class X360GameHack : MetroForm
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            {
                Text = Text + " v" + Pastebin.CurrentVersion + " Latest Version";
            }
            else
            {
                Text = Text + " Your Using An Outdated Version!" + " Latest Version is " + Pastebin.CurrentVersion + "!";
            }
       ...
       //   
        ...
        {
            MessageBox.Show("Enjoying X360GameHack? Consider buying me a coffee with cashapp $Collin3400 your donations are apprecieated and contribute to the further development of this tool.");
        }
